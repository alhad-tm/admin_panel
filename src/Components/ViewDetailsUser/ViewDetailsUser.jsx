...
import css from "./ViewDetailsUser.module.css"
...
const ViewDetailsUser = () => {
  return (
    ...
    {/* right side */}
              <div className={css.bright}>
                ...
                <ul className={css.timelinelist}>
                 <div><li>Onboarded</li> <span style={{fontSize:"10px"}}>23-05-2023</span> </div>
      <div><li>Credential provided</li> <span style={{fontSize:"10px"}}>23-05-2023</span> </div>
     <div><li>Documentation verified(manual)</li> <span style={{fontSize:"10px"}}>23-05-2023</span> </div>
     <div><li>Documentation received</li> <span style={{fontSize:"10px"}}>23-05-2023</span> </div>
       <div><li>Documentation sent</li> <span style={{fontSize:"10px"}}>23-05-2023</span> </div>  
    ...
    <button className={css.declineb} >Decline</button>
     <button className={css.sentdocb} >Sent Documentation URL</button>
    <button className={css.sentdocb} >Resent Documentation URL</button>
    <button className={css.declineb} >Request for modification</button>
    <button className={css.sentdocb} >Verified</button>
    <button className={css.sentdocb} >Sent Credentials</button>
     <button className={css.sentdocb} >Resent Credentials</button>  
    </div> */}
